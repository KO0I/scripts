...
#mount //thebrain.colorado.edu/groups /mnt/brain/groups -o ip=128.138.110.12,domain=ad,username=$user,password=$pass
#mount //thebrain.colorado.edu/users /mnt/brain/users -o ip=128.138.110.12,domain=ad,username=$user,password=$pass
